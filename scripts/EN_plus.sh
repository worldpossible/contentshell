...
rsync -avz --del rsync://$1/rachelmods/en-hesperian_health /media/RACHEL/rachel/modules/
rsync -avz --del rsync://$1/rachelmods/en-infonet /media/RACHEL/rachel/modules/
rsync -avz --del rsync://$1/rachelmods/en-local_content /media/RACHEL/rachel/modules/
rsync -avz --del rsync://$1/rachelmods/en-math_expression /media/RACHEL/rachel/modules/
rsync -avz --del rsync://$1/rachelmods/en-medline_plus /media/RACHEL/rachel/modules/
...
rsync -avz --del rsync://$1/rachelmods/en-iicba /media/RACHEL/rachel/modules/
...
rsync -avz --del rsync://$1/rachelmods/en-windows_apps /media/RACHEL/rachel/modules/
